        ...
        <div class="wai_box">
            ...
            <div class="content_box content_box_summarize">
                ...
                <!--<el-row style="margin-top: 20px">-->
                    <!--<el-col  > <span style="font-size: 14px;font-weight: 700">作者：</span>{{messageInfo.article_author}}</el-col>-->
                <!--</el-row>-->
                ...
                <!--<el-row style="margin-top: 20px">-->
                    <!--<el-col  > <span style="font-size: 14px;font-weight: 700">索引：</span>{{messageInfo.article_message}}</el-col>-->
                <!--</el-row>-->
                <div style="display: flex;font-size: 14px;margin:10px 0 0 25px">
                ...
                <!--<el-row style="margin-top: 20px">-->
                    <!--<el-col>-->
                        <!--<span style="font-size: 14px;font-weight: 700">文献概述：</span>-->
                        <!--{{messageInfo.article_content}}-->
                    <!--</el-col>-->
                <!--</el-row>-->
                <div style="display: flex;font-size: 14px;margin:10px 0 0 25px">
            ...
            <div class="content_box" :class="[zk1?'':'maxhe']">
                <div v-for="(item,index) in messageInfo.dis" class="content_box_item ">
                    ...
                    <div class="display">
                        <div style="font-weight: bold">量表值</div>
                    </div>
                    <div class="topic_box">
                        <el-table
                                border
            ...
            <div class="content_box">
                <div v-for="(mould,index) in messageInfo.mould" class="wai_mouldbox">
                    ...
                    <div class="mouldbox">
                        ...
                        <!--<div class="mouldbox_tit">-->
                            <!--<span :span="6"> <span style="font-weight: 600">索引信息：</span> {{mould.article_message}}</span>-->
                        <!--</div>-->
                        ...
                        <div class="guanxi">
                            <div style="font-weight: 600;min-width: 70px">变量关系：</div>
                            <div style="text-align: left">
                                <div v-for="(relation,index)  in mould.rea" style="display: inline">
                                    ...
                                    <span  v-if="index!=mould.rea.length-1">，</span>
                                </div>
                            </div>
                        </div>
                        <div class="mouldbox_bot_box">
                            <!--<div class="mouldbox_left">-->
                                <!--<el-row style="padding: 0">-->
                                    <!--<el-col :span="2" style="font-weight: 600">概述：</el-col>-->
		...
		methods:{
            ...
            getBack(){
	            if(this.$route.query.type==2){
		            ...
		            this.$router.push({path:"/mine_fun_item",query: {id:this.$route.query.id}})
                }else {
